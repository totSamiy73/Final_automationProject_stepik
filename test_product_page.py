...
def test_guest_can_add_product_to_basket(browser, link):
    ...
    page.message_added_to_basket()
    page.name_product_in_message()
    page.message_cart_cost()
    page.cart_price_same_as_the_product()
...
def test_guest_cant_see_product_in_basket_opened_from_product_page(browser):
    ...
    basket_page.message_product_not_in_basket()
...
class TestUserAddToBasketFromProductPage:
    ...
    def test_user_can_add_product_to_basket(self, browser):
        ...
        self.page.message_added_to_basket()
        self.page.name_product_in_message()
        self.page.message_cart_cost()
        self.page.cart_price_same_as_the_product()